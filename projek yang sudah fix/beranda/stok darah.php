        ...
        <table class="w-full">
            ...
            <tbody>
                <tr class="app-border-1">
                    ...
                    <td>
                        <span class="font-semibold text-sm app-color-gray-1">20 kantong</span>
                    </td>
                    <td>
                        <span class="font-semibold text-sm app-color-gray-1">31 Mei 2022</span>
                    </td>
                    <td>
                ...
                <tr class="app-border-1">
                    ...
                    <td>
                        <span class="font-semibold text-sm app-color-gray-1">12 kantong</span>    
                    </td>
                    <td>
                        <span class="font-semibold text-sm app-color-gray-1">23 Mei 2022</span>
                    </td>
                    <td>
                  ...
                  <tr class="app-border-1">
                    ...
                    <td>
                        <span class="font-semibold text-sm app-color-gray-1">4 kantong</span>    
                    </td>
                    <td>
                        <span class="font-semibold text-sm app-color-gray-1">2 Juni 2022</span>
                    </td>
                    <td>
                  ...
                  <tr class="app-border-1">
                    ...
                    <td>
                        <span class="font-semibold text-sm app-color-gray-1">19 kantong</span>    
                    </td>
                    <td>
                        <span class="font-semibold text-sm app-color-gray-1">4 Juni 2022</span>
                    </td>
                    <td>
                        <div class="h-8 w-28 font-semibold text-sm app-bg-blue-2 flex items-center justify-center app-color-blue-1 rounded-md">
                            0812 7848 6647
